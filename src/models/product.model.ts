import { z } from "zod";
import { PaginationQuerySchema } from "./shared/request.model";
...
import { CategoryIncludeTranslationSchema } from "./shared/shared-category.model";
...
export const GetProductsQuerySchema = PaginationQuerySchema.extend({
  ...
  sortBy: z
    .enum([SortBy.Price, SortBy.CreatedAt, SortBy.Sale])
